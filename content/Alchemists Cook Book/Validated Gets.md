...
![[IO_TraceCode.png]]
This is the **Interaction trace** that scans for *Interactive Objects* as part of the [[Hangar Brief (Outdated)]]! This check simply does two validation checks based on if the player trace **is colliding** or **is not colliding** with an *interactive object*!
