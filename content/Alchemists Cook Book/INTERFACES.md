...
Can be used in **Trace** or *Overlap* styled events to query if the *Queried Actor* contains a specific *Interface* and return a **Boolean** answer - This was ESPECIALLY useful during the [[Hangar Brief (Outdated)#luc_person_standing Player Character| Hanger Character]] *sphere trace* that checks only for *interactive objects*!
